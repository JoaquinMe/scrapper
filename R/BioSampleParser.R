...
#TODO: borrar esto cuando sea correcto
test_input=c("PRJNA1251497","PRJEB47093","PRJDB10962")
...
.fetch_related_biosamples= function(ids)
{
...
get_biosample_metadata=function(bioproject_accessions)
{
  ...
  if (length(valid_ids) == 0) {
    stop(" None of the provided IDs match the expected format: PRJ(E|D|N)[A-Z][0-9]+")
  }
